...
public class TransactionDTO {
	...
	public String getT_a_no_1() {
		return t_a_no_1;
	}
	public void setT_a_no_1(String t_a_no_1) {
		this.t_a_no_1 = t_a_no_1;
	}
	...
	public String toString() {
		return "TransactionDTO [t_no=" + t_no + ", t_a_no_1=" + t_a_no_1 + ", t_dist=" + t_dist + ", t_amount="
				+ t_amount + ", t_datetime=" + t_datetime + "]";
	}
