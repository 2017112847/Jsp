...
<%--request
	...
	post 요청
	- 데이터를 요청 객체의 body 에 저장해서 전송되는 방식 
...
<h4>GET요청</h4>
<a href = "./proc/result1.jsp?uid=a101">결과 페이지1</a>
<a href = "./proc/result1.jsp?uid=a102&name=홍길동">결과 페이지2</a>
<a href = "./proc/result1.jsp?uid=a103&name=김유신&age=23">결과 페이지3</a>
<h4>POST 요청</h4>
...
<table border = "1">
	...
	<h4>request 자주 사용하는 클라이언트</h4>
	<p>
		헤더정보 #1 : <%= request.getHeader("User-Agent") %><br/>
		헤더정보 #2 : <%= request.getHeader("refere") %><br/> <!-- 이전 페이지-->
